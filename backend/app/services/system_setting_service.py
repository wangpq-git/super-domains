...
SETTING_DEFINITIONS = {
    ...
    "FEISHU_BOT_APP_ID": {
        "category": "feishu",
        "label": "飞书应用 App ID",
        "description": "应用机器人发送审批卡片时使用的 App ID。",
        "value_type": "string",
        "default": "",
        "is_secret": False,
        "restart_required": False,
    ...
    "FEISHU_BOT_APP_SECRET": {
        ...
        "description": "应用机器人发送审批卡片时使用的 App Secret。",
        "value_type": "string",
        "default": "",
        "is_secret": True,
        "restart_required": False,
    ...
    "FEISHU_APPROVAL_CHAT_ID": {
        "category": "feishu",
        "label": "飞书审批群 Chat ID",
        "description": "应用机器人发送审批卡片的目标群 chat_id。",
        "value_type": "string",
        "default": "",
        "is_secret": False,
        "restart_required": False,
    ...
    "K8S_INGRESS_KUBECONFIG": {
        "category": "service_discovery",
        "label": "K8s Kubeconfig",
        "description": "用于读取 Ingress 的 kubeconfig 内容，支持粘贴 YAML 或 JSON。",
        "value_type": "string",
        "ui_type": "textarea",
        "rows": 12,
        "default": "",
    ...
    "K8S_INGRESS_NAMESPACE_OPTIONS": {
        "category": "service_discovery",
        "label": "Ingress 命名空间选项",
        "description": 'JSON 数组，例如 [{"label":"生产","namespace":"prod"}]。',
        "value_type": "json",
        "rows": 8,
        "default": [],
        "is_secret": False,
    ...
    "K8S_INGRESS_REQUEST_TIMEOUT_SECONDS": {
        "category": "service_discovery",
        "label": "K8s 请求超时秒数",
        "description": "读取 Ingress 信息时的 API 请求超时时间。",
        "value_type": "integer",
        "default": 15,
        "is_secret": False,
        "restart_required": False,
    ...
    "TENCENT_COS_SECRET_ID": {
        "category": "cos_discovery",
        "label": "腾讯云 SecretId",
        "description": "用于读取 COS 存储桶与自定义域名配置。",
        "value_type": "string",
        "default": "",
        "is_secret": True,
        "restart_required": False,
    ...
    "TENCENT_COS_REQUEST_TIMEOUT_SECONDS": {
        "category": "cos_discovery",
        "label": "COS 请求超时秒数",
...
async def list_settings(db: AsyncSession) -> list[dict[str, Any]]:
    ...
    for item in resolved:
        ...
        items.append({
            ...
            "ui_type": item.definition.get("ui_type", "input"),
            "rows": item.definition.get("rows"),
